...
public class ReqHead implements Head {
	...
	public String toString() {
		return "HeadBean [getVER()=" + getVER() + ", getMsgNo()=" + getMsgNo() + ", getCHKDate()=" + getCHKDate()
				+ ", getWorkDate()=" + getWorkDate() + ", getWorkTime()=" + getWorkTime() + ", getADD()=" + getADD()
				+ ", getSRC()=" + getSRC() + ", getDES()=" + getDES() + ", getAPP()=" + getAPP() + ", getMsgID()="
				+ getMsgID() + ", getReserve()=" + getReserve() + ", getSign()=" + getSign() + ", getClass()="
