		...
		final String xml="<?xml version=\"1.0\" encoding=\"GBK\"?>"+
				"<JFDH>"
					+ "<HEAD>"
						...
						+ "<APP>杭州蓝喜积分兑换平台</APP>"
						+ "<MsgNo>1001</MsgNo>"
						+ "<CHKDate>20170118</CHKDate>"
						+ "<WorkDate>20170118</WorkDate>"
						+ "<WorkTime>111600</WorkTime>"
						+ "<ADD>11</ADD>"
						+ "<SRC>1000000000000000</SRC>"
						+ "<DES>1000000000000000</DES>"
						+ "<MsgID>20010001</MsgID>"
						+ "<Reserve>我就试试</Reserve>"
						+ "<Sign>ec2c524f07fa4cc8ace8f093e0dbc3bd</Sign>"
						+ "</HEAD>"
					+ "<MSG>"
						+ "<Phone>15068610940</Phone>"
						+ "<SkuCode>3050</SkuCode>"
						+ "<Type>30</Type>"
						+ "<Count>1</Count>"
						+ "<NeedSend>0</NeedSend>"
						+ "<Remark>我就试试</Remark>"
